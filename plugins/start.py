    ...
    if len(text)>7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply("Sabar dulu cok...!")
        try:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🗿Klik sayang", callback_data = "about"),
...
async def not_joined(client: Client, message: Message):
    text = "<b>⚠️Maap, akses ke bot ditolak !!\n\nUntuk menggunakan bot ini, lo harus Join ke channel dengan tekan tombol dibawah ini lalu klik Join/Gabung. kalo udah</b>"
